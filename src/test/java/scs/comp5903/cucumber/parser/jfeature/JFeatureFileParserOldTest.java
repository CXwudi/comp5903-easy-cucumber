 ...
 * @date 2022-06-22
 */
class JFeatureFileParserOldTest {
  ...
  void canIgnoreCommentsAndDescription() throws URISyntaxException {
    var jFeatureDetail = new StateMachineJFeatureFileParser().parse(ResourceUtil.getResourcePath("sample/jfeature/multi-line-description-old.jfeature"));
  ...
  void canParseTags() throws URISyntaxException {
    var jFeatureDetail = new StateMachineJFeatureFileParser().parse(ResourceUtil.getResourcePath("sample/jfeature/multi-line-description-with-tags-old.jfeature"));
    assertEquals("This is a feature with description and comments", jFeatureDetail.getTitle());
